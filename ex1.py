...
stringList = ["разработка", "сокет", "декоратор"]
byteList = ["\u0440\u0430\u0437\u0440\u0430\u0431\u043e\u0442\u043a\u0430",
           "\u0441\u043e\u043a\u0435\u0442",
           "\u0434\u0435\u043a\u043e\u0440\u0430\u0442\u043e\u0440"]

for i in range(len(stringList)):
    print(f"{stringList[i]} ---- {type(stringList[i])}")
    print(f"{byteList[i]} ---- {type(byteList[i])}")
    print(f"{stringList[i]} == {byteList[i]} ---- {stringList[i] == byteList[i]}\n")
